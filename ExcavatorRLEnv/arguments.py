...
def get_args():
    ...
    parser.add_argument('--ppo_episodes', type=int, default=500, metavar='G', help='Number of episodes for PPO')
    ...
    args.save_dir = os.path.join(args.save_dir, 'train', str(args.test_id))
